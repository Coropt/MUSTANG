...
class SSC_Dataset(Dataset):
    def __init__(self, eval_length=16, seed=1, mode="train", val_len=0.1, test_len=0.2, test_missing='point',
        ...
        # 筛选12个站点（SSC_pooled.csv 列名没有前导0）
        selected_stations_8 = [
        ...
        path = "./original_data/Discharge/ssc_meanstd.pk"
...
def get_dataloader_SSC(sequence_length, batch_size, device, seed=45678, val_len=0.1, test_len=0.2, num_workers=4, 
                   test_missing='block', training_missing='block', missing_ratio=0.1, pretrain_missing_rate=None):
    dataset = SSC_Dataset(eval_length=sequence_length, seed=seed, mode="train", val_len=val_len, test_len=test_len,
    ...
    dataset_test = SSC_Dataset(eval_length=sequence_length, seed=seed, mode="test", val_len=val_len, test_len=test_len,
                             test_missing=test_missing, training_missing=training_missing, missing_ratio=missing_ratio,
                             pretrain_missing_rate=pretrain_missing_rate)
    test_loader = DataLoader(
        dataset_test, batch_size=batch_size, num_workers=num_workers, shuffle=False
    )
    dataset_valid = SSC_Dataset(eval_length=sequence_length, seed=seed, mode="valid", val_len=val_len, test_len=test_len,
                             test_missing=test_missing, training_missing=training_missing, missing_ratio=missing_ratio,
                             pretrain_missing_rate=pretrain_missing_rate)
