...
class NH4_Dataset(Dataset):
    def __init__(self, eval_length=16, seed=1, mode="train", val_len=0.1, test_len=0.2, test_missing='point',
        ...
        df = pd.read_csv('./original_data/Nitrate/NH4_pooled.csv', index_col=0)
        ...
        path = "./original_data/Nitrate/nh4_meanstd.pk"
...
def get_dataloader_NH4(sequence_length, batch_size, device, seed=45678, val_len=0.1, test_len=0.2, num_workers=4, 
                   test_missing='block', training_missing='block', missing_ratio=0.1, pretrain_missing_rate=None):
    dataset = NH4_Dataset(eval_length=sequence_length, seed=seed, mode="train", val_len=val_len, test_len=test_len,
    ...
    dataset_test = NH4_Dataset(eval_length=sequence_length, seed=seed, mode="test", val_len=val_len, test_len=test_len,
                             test_missing=test_missing, training_missing=training_missing, missing_ratio=missing_ratio,
                             pretrain_missing_rate=pretrain_missing_rate)
    test_loader = DataLoader(
        dataset_test, batch_size=batch_size, num_workers=num_workers, shuffle=False
    )
    dataset_valid = NH4_Dataset(eval_length=sequence_length, seed=seed, mode="valid", val_len=val_len, test_len=test_len,
                             test_missing=test_missing, training_missing=training_missing, missing_ratio=missing_ratio,
                             pretrain_missing_rate=pretrain_missing_rate)
